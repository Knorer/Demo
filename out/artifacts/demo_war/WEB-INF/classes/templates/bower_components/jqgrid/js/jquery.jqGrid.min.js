...
k,n,p,q,r,s,t,u,v,w,x,y=$(e),z=0,B=[],C=e.p.multiselect?1:0,D=!0===e.p.subGrid?1:0,K=!0===e.p.rownumbers?1:0,L=I(C+D+K),N=H(h),O={},P=[],Q=l(m,"rowBox",!0,"jqgrow ui-row-"+e.p.direction);e.p.page=A($.jgrid.getAccessor(a,g.page),e.p.page),e.p.lastpage=A($.jgrid.getAccessor(a,g.total),1),e.p.records=A($.jgrid.getAccessor(a,g.records)),e.p.totalSum =A($.jgrid.getAccessor(a,g.totalSum )),e.p.userData=$.jgrid.getAccessor(a,g.userdata)||{},D&&(r=$.jgrid.getMethod("addSubGridCell")),v=!1===e.p.keyName?$.isFunction(g.id)?g.id.call(e,a):g.id:e.p.keyName,g.repeatitems&&e.p.keyName&&isNaN(v)&&(v=e.p.keyIndex),u=$.jgrid.getAccessor(a,g.root),null==u&&$.isArray(a)&&(u=a),u||(u=[]),t=u.length,n=0,t>0&&e.p.page<=0&&(e.p.page=1);var
